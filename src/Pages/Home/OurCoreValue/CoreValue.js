        ...
        <div className='font-serif'>
            ...
            <div className='mx-10 pb-20 pt-10 '>
                ...
                <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-3'>
                    ...
                    <div className="card bg-orange-50 text-neutral-content">
                        <div className="card-body items-center text-center text-black">
                            <p className='bg-violet-500 px-4 py-2 text-3xl rounded-lg text-white'><i className="fa-regular fa-star"></i></p>
                    ...
                    <div className="card bg-orange-50 text-neutral-content">
                        <div className="card-body items-center text-center text-black">
                            <p className='bg-violet-500 px-4 py-2 text-3xl rounded-lg text-white'><i className="fa-regular fa-comment"></i></p>
                    ...
                    <div className="card  bg-orange-50 text-neutral-content">
                        <div className="card-body items-center text-center text-black">
                            <p className='bg-violet-500 px-4 py-2 text-3xl rounded-lg text-white'><i className="fa-solid fa-clock"></i></p>
