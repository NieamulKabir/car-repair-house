...
const NotFound = () => {
    return (
        <div>
            ...
            <button className="mt-7 py-3 px-8 mb-20 bg-yellow-400 rounded text-gray-800 hover:bg-white transition duration-300"><NavLink to="/home">BACK TO HOME</NavLink></button>
        </div>
    );
};
